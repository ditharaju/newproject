...
<div class="wrapper row3">
      ...
      <section>
           <ul class="nospace clear small-scrn">
	                 ...
	                 <div class="four_fifth">
	                   <h2 class="font-large nospace" style="font-family:Comic sans MS;">Create Business Document</h2>
 ...
 <!-- ################################################################################################ -->
    <div class="three_quarter">
        ...
        <h1 style="font-family:Comic sans MS;">Create Business Document</h1>
...
<form name="busdoccreate" method="post" action="busdoccreate1.php" enctype="multipart/form-data" onsubmit="return validateForm()">
<ul class="nospace clear">
                    <li class="one_quarter first"><div style="text-align:right;border:0px solid #cfcfcf;">Group ID:</div></li>
                    <li class="one_quarter" style="height: 20px;" ><input type="text"name="grpid" value="<?php echo $grpid ?>" /></li>
                    <li class="one_quarter"><div style="text-align: right;border:0px solid #cfcfcf;">Group Name:</div></li>
                     <li class="one_quarter" style="height: 20px;" > <input type="text" name="grpname" value="<?php echo $grpname ?>"/></li>
      <br><br><br>


                  <li class="one_quarter first"><div style="text-align: right;border:0px solid #cfcfcf;">Identifier:</div></li>
				                     <li class="one_quarter" style="height: 20px;" >  <select name="ident" required>
				    ...
				    <li class="one_quarter"><div style="text-align:right;border:0px solid #cfcfcf;">Search Term:</div></li>
				       <li class="one_quarter" style="height: 20px;" ><input type="text"name="search" required /></li>
    ...
    <br><br><br>
                 ...
                 <li class="one_quarter first"><div style="text-align: right;border:0px solid #cfcfcf;">Description:</div></li>
				       <li class="one_quarter" style="height: 20px;" > <input type="text" name="descp" /></li>
...
<input type="submit" class="button small red" name="create" value="Create Business Document"/>
