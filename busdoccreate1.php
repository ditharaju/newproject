      ...
      <section>
           <ul class="nospace clear small-scrn">
	                 ...
	                 <div class="four_fifth">
	                   <h2 class="font-large nospace">Business document</h2>
...
$others = $_REQUEST['others'];
	...
	$sql="INSERT INTO business values('','$groupid','$groupname','$identifier','$searchterm','$title1','$description','$others','$userid','$date','','','','','','')";
...
echo "<h3> New Business Document <b>$title1</b> created </h3>";
