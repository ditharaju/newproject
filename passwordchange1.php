...
$get	=	mysqli_fetch_array(mysqli_query($con,"SELECT a.username,a.userid,a.password,a.groupid,b.description FROM usertable a ,groups b WHERE a.userid='$id' && a.groupid = b.groupid "));
$user	=	$get['username'];
$userid	=	$get['userid'];
...
$sql="select userid from usertable where userid = '$userid' and password = '$b'";
$results=mysqli_query($con,$sql);
$count=mysqli_num_rows($results);

if($count == 1)
{
$sql = " UPDATE usertable SET password ='$c' where userid = '$userid' and password = '$b'";
$result=mysqli_query($con,$sql);

echo "<h3>  Password for <b>$user</b> is changed</h3>";
}
else {
echo "<h3>  Old Password does not match</h3>";
}
