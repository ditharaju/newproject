...
$sql="SELECT busid,Identifier,SearchTerm,Title1,others,groupname,groupid FROM business WHERE SearchTerm ='$SearchTerm'";
...
while($result=mysqli_fetch_array($resource))
	...
	<td>".$result[3]."</td>
	<td>".$result[4]."</td>
    <td><a href='busdocdisplay2.php?search=".$result[2]. "'>Display</td>
	</tr>";
	} echo "</table></font>";
   	}

?>
<footer><a href="busdocdisplay.php" class="button small red">BACK </a></footer>
