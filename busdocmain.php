  ...
  <nav id="topnav">
    <ul class="clear">
			<li>&nbsp;</li>
              ...
              <li id="menu_services"><a class="drop" href="busdocmain.php" title="Services">Business</a>
      ...
      <section>
        <ul class="nospace clear small-scrn">
              ...
              <div class="four_fifth">
                <h2 class="font-large nospace">Business document<BR>Maintenance</h2>
                    ...
                    <li class="one_quarter">
                        <article class="clear">
              <div class="one_third first push-right-bottom"><a href="busdoccreate.php"><img src="images/creategood.png" alt=""></a></div>
              <div class="four_fifth">
                <h2 class="font-large nospace">Create Business document</h2>
                    ...
                    <li class="one_quarter">
                        <article class="clear">
              <div class="one_third first push-right-bottom"><a href="busdocchange.php"><img src="images/changegood.jpg" alt=""></a></div>
              <div class="four_fifth">
             ...
             <li class="one_quarter">
		  	                           <article class="clear">
		  	                 <div class="one_third first push-right-bottom"><a href="busdocdisplay.php"><img src="images/displaygood.png" alt=""></a></div>
		  	                 <div class="four_fifth">Display Business document</h2>

		                                  <!--<footer><a href="#" class="button small red">More.. &raquo;</a></footer>-->
		                                </div>
