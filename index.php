...
<div class="wrapper row1">
  <header id="header" class="full_width clear">
    <hgroup>
      <h1><a href="index2.php"><img src="images/eorglogo.jpg"/></a></h1>
    </hgroup>
      ...
      <section>
        <ul class="nospace clear small-scrn">
              ...
              <div class="four_fifth">
                <h2 class="font-large nospace">LOGIN</h2>
...
User <input type="text" name="user" style="width: 30%;"><br><Br>
Pass <input type="password" name="pass" style="width: 30%;"><br><Br>
<input type="submit" class="button small red" value="LOGIN"><br><Br>
</form>
         </div>
