...
if( $fileSize < 5000000 )
  {
  $sql="UPDATE business SET Identifier='$identifier', SearchTerm='$searchterm',Title1='$title1',Description='$description',others='$others',changedby='$id',changedate='$date',filename='$fileName',filetype='$fileType',filesize='$fileSize',filecontent='$content' WHERE busid='$busid' AND groupid='$grpid'";
 }
else

{
   ...
   echo "<script>";
   echo " alert('Filesize should be less than 5MB.');
          window.history.go(-1);
           </script>";
...
$sql="UPDATE business SET Identifier='$identifier', SearchTerm='$searchterm',Title1='$title1',Description='$description',others='$others',changedby='$id',changedate='$date' WHERE busid='$busid' AND groupid='$grpid'";
...
echo "<h3>  Business Document <b>$title1</b> is changed</h3>";

				  						mysqli_close($con);

				  						?>

<footer><a href="busdocmain.php" class="button small red">BACK </a></footer>
